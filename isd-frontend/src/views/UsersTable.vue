              ...
              <table class="table " cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th>
                      <span
                        name="sortByEmploymentDate"
                        class="sort-column"
                        @click="switchDateSortDirection"
                        >Employment Date <span v-html="sortIcon"></span
                      ></span>
                    </th>
                    <th>Active</th>
...
export default {
  ...
  data() {
    return {
      ...
      firstNameRules: [
        ...
        v =>
          /^[A-Z]+[a-z]+$/.test(v) ||
          "First Name must be only letters, big and small"
      ],
      lastNameRules: [
        v => !!v || "First Name is required",
        v =>
  ...
  methods: {
    ...
    getUsers() {
      let datSortParam =
        this.sortByEmploymentDate != null
          ? "&sort=employmentDate," + this.sortByEmploymentDate
          : "";

      api
        .getUsers({ page: this.page - 1, employmentDateSort: datSortParam })
        .then(response => {
